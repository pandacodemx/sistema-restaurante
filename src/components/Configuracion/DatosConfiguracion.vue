<template>
    <section>
        ...
        <div class="has-text-centered">
            <b-button type="is-success" size="is-large" class="is-rounded has-text-weight-light"
                icon-left="content-save" @click="registrar">Guardar</b-button>
        </div>
    </section>
</template>
<script>
